...
### `get_http_headers` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/fastmcp_slim/fastmcp/client/dependencies.py#L4" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
