...
### `LifespanMixin` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/fastmcp_slim/fastmcp/server/mixins/lifespan.py#L41" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `docket` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/fastmcp_slim/fastmcp/server/mixins/lifespan.py#L45" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
